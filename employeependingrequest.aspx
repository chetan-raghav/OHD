<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="employeependingrequest.aspx.cs" Inherits="employeependingrequest" %>
   ...
   <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/del.png" CausesValidation="false" CommandName="deletedmail" AlternateText="deleted request" OnClick="ImageButton4_Click" />
             ...
             <td id="test1" runat="server" visible="false" align="center">
                <asp:Label ID="Label1" runat="server" Text="Reply"></asp:Label><br />
                 ...
                 <asp:TextBox ID="TextBox3" runat="server" placeholder="give reason for the same....."></asp:TextBox>                
