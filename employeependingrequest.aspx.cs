...
public partial class employeependingrequest : System.Web.UI.Page
{
    ...
    protected void BindGridview()
    {
        ...
        SqlConnection con = new SqlConnection(CS);
        con.Open();
        string str = "select request.rid , request.issued from request,preq where request.rid=preq.rid AND preq.eid = '" + Session["eid"] + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Response.Redirect("employeependingrequest.aspx");
            }
        }
    }
